...
// -------------------------------------------------------------------------------------------------------
    this.create = function() {
      ...
      if(document.layers) {
        ...
        else document.all.fusionTooltip.innerHTML = t;
      }
      this.show();
    }
    ...
    this.init = function() {
      if(document.getElementById) {
        ...
        this.obj = document.all.fusionTooltip;
        this.sobj = this.obj.style;
      }
      else if(document.layers) {
        this.obj = document.fusionTooltip;
        this.sobj = this.obj;
      }
    }
...
//----------------------------------------------------------------------------------------------------
  var fusionTooltip = mouseX = mouseY = winX = 0;
  ...
  function getMouseXY(e) {
    ...
    if(fusionTooltip && fusionTooltip.active) fusionTooltip.show();
  }
