...
<div class="main-game-contents">
    ...
    <a href="/server/realmstatus" class="main-content-banner right-bnr bnr03" style="background-image:url('{$theme_path}images/boxes/thumb-main-content-3.jpg');">
        <span class="banner-title">Realmstatus</span>
