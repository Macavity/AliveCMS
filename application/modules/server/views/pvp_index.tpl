            ...
            {foreach from=$teams[$mode] key=$rank item=$teamId}
              <li class="{$team.css_rank}">
                ...
                <div class="rating-realm">
                  ...
                  <span class="realm">{$team.factionLabel}</span>
                </div>
                <div class="members">
                  {foreach from=$team.members item=$player}
  ...
  <ul class="dynamic-menu" id="menu-pvp">
    ...
    <li class="has-submenu">
      ...
      <ul class="dynamic-menu" id="menu-pvp-{$mode}">
        {foreach from=$realms item=realm}
          <li>
            <a href="{$url}server/pvp/arena/{$mode}/{$realm.id}">
              <span class="arrow">{$realm.realmName}</span>
            </a>
          </li>
        {/foreach}
      </ul>
    ...
    <li class="has-submenu">
      ...
      <ul class="dynamic-menu" id="menu-pvp-{$mode}">
        {foreach from=$realms item=realm}
          <li>
            <a href="{$url}server/pvp/honor/{$realm.id}">
              <span class="arrow">{$realm.realmName}</span>
            </a>
          </li>
        {/foreach}
