...
<div class="ucp_divider"></div>
	...
	<div class="search_result_character">
		<a href="{$url}character/{$realmId}/{$leader.name}"><img width="54" height="54" src="{$url}{$leader.avatar}" class="avatar"/></a>
	...
	{if $members}
		{foreach from=$members item=character}
			{if $character.guid != $guild.leaderguid}
				<div class="search_result_character">
					<a href="{$url}character/{$realmId}/{$character.name}"><img width="54" height="54" src="{$url}{$character.avatar}" class="avatar"/></a>
