...
<div class="user-plate ajax-update">
    ...
    <div class="meta-wrapper meta-{$factionString}">
        <div class="meta">
            ...
            <div class="character">
                <a id="selected-character" class="character-name context-link" data-realmid="{$activeChar.realmId}" data-realmname="{$activeChar.realmName}" data-name="{$activeChar.name}" href="{$activeChar.url}" data-tooltip="Charakter wechseln" data-tooltip-options="{literal}{&quot;location&quot;: &quot;topCenter&quot;}{/literal}">
                    {$activeChar.name}
