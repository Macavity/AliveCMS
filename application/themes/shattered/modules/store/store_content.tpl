        ...
        <table>
            ...
            {foreach from=$groups item=group}
                ...
                <tr class="{cycle values="row1,row2"}">
                    ...
                    <td>
                        <img src="{$url}application/images/icons/cart_put.png" class="jsPutToCart" data-realm="{$realm_id}" data-price="{$item.vp_price}" data-name="{$item.name}" data-icon="{$item.icon}" data-id="{$item.id}" data-itemid="{$item.itemid}">
                    </td>
                </tr>
                {/foreach}
            {/foreach}
